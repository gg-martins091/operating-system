...
nasm boot/boot.asm -f bin -o build/boot.bin -i boot;
...
# to use gdb, pass -s -S to qemu, and connect gdb: 
#gdb vmlinux
#(gdb) target remote localhost:1234
#(gdb) c /// this will launch the kernel
#more info https://www.qemu.org/docs/master/system/gdb.html
